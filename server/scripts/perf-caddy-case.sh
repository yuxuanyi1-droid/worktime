...
#
# 用法：
#   bash scripts/perf-caddy-case.sh snapshot
#   bash scripts/perf-caddy-case.sh run 4 20 200 2000 batch20-c200
#   bash scripts/perf-caddy-case.sh restore
#   bash scripts/perf-caddy-case.sh stop
set -euo pipefail
